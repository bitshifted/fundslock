...
func Test_GetAgreementsSuccess(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/agreements", nil)
	...
	assert.Equal(t, "[{\"agreement_id\":\"123\",\"seller\":\"0x1231231323344\",\"buyer\":\"0x3453453453453\",\"amount\":\"1000\",\"status\":1,\"timestamp\":\"123455667\"}]\n", string(body))
